 ...
 * computed for every currently-known student right away (baseAmountPerStudent minus that
 * student's piggy bank balance at this moment, floored at zero). There is deliberately no
...
public interface CreateCollectionUseCase {
    ...
    Collection createCollection(String title, String description, BigDecimal baseAmountPerStudent);
}
